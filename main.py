...
def optimize(frontend_data: FrontendInterface):
    optimization_params = OptimizationParameters(team_optimization_parameters={}, financial_metric="", performance_metric="", dont_consider_ufas=True, adjust_for_age=True)
